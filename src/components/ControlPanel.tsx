...
export const ControlPanel: React.FC<ControlPanelProps> = ({
  ...
  return (
    <div className="flex flex-col items-center gap-6 animate-in zoom-in duration-300">
      ...
      <button
        onClick={onConnect}
        className="group relative flex items-center justify-center w-24 h-24 rounded-full shadow-2xl hover:scale-105 active:scale-95 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-sakura-300"
        style={{
      ...
      >
        ...
        <Phone size={40} style={{ fill: 'currentColor' }} />
      </button>
    </div>
  );
};